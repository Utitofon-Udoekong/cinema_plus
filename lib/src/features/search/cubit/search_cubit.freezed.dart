...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl(
      ...
      required final List<Movie> searchResult,
  ...
  @override
  String toString() {
    return 'SearchState(isLoading: $isLoading, searchResult: $searchResult, selectedMovie: $selectedMovie, errorMessage: $errorMessage)';
  }
...
abstract class _SearchState implements SearchState {
  const factory _SearchState(
      ...
      required final String? errorMessage}) = _$SearchStateImpl;
