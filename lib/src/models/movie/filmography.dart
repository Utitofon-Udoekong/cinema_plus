...
class Filmography {
  ...
  factory Filmography.fromMap(Map<String, dynamic> map) {
    return Filmography(
  ...
  factory Filmography.fromJson(String source) => Filmography.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'Filmography(cast: $cast, id: $id)';

  @override
  bool operator ==(covariant Filmography other) {
  ...
  @override
  int get hashCode => cast.hashCode ^ id.hashCode;
}
